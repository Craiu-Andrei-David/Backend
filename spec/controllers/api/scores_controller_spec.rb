...
describe Api::ScoresController, type: :request do
  ...
  describe 'Get max 25 feed' do
    it 'should return a feed with less than 25 scores' do
      
      user=User.create!( name:"Example", email: "example@gmail.com", password: "example")
      30.times do |i|
        Score.create!(user:user, total_score: 55,  played_at: Date.today-i.days)
      end
